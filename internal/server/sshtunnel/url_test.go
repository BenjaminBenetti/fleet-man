...
func TestSSHArgs(t *testing.T) {
	...
	for _, want := range []string{"-o BatchMode=yes", "-o StrictHostKeyChecking=yes", "-o UpdateHostKeys=no", "-o CheckHostIP=no", "-o ConnectTimeout=15", "-p 2222", "-N -L 127.0.0.1:1:127.0.0.1:2"} {
